...
| Example | Description |
|---------|-------------|
| [California Housing Regression](https://github.com/michelangelo-ai/michelangelo/tree/main/python/examples/california_housing_xgb) | Predict house prices with XGBoost |
